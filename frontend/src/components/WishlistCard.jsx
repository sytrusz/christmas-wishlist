...
export default function WishlistCard({ wishlist }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="bg-white border-2 border-gray-800 p-6 cursor-pointer hover:shadow-xl transition-shadow duration-200"
    >
      <h3 className="text-xl font-bold mb-3 text-gray-900">{wishlist.ownerName}</h3>
